...
def main():
    ...
    for test in tests.values():
        ...
        print "Sequential took %10.7f seconds to run on average" % (output['seq']/ 100)
        print "Ordered Seq took %10.7f seconds to run on average" % (output['ord_seq'] / 100)
        print "Binary Iter took %10.7f seconds to run on average" % (output['bin_iter']/ 100)
        print "Binary Recur took %10.7f seconds to run on average" % (output['bin_recur']/ 100)
        print '\n'
